...
public final class CollisionDetector {
	public boolean collide(IMShape s1, IMShape s2) {
		if (s1 instanceof MPolygon)
			...
			throw new IllegalArgumentException("Don't know how to check these objects for collision: " + s1 + " and " + s2);
	}
	...
	public boolean collide(MCircle c, IMShape s) {
		if (s instanceof MCircle)
			...
			throw new IllegalArgumentException("Don't know how to check this object for collision with a MCircle: " + s);
	}
	...
	public boolean collide(MLine l, IMShape s) {
		if (s instanceof MLine)
			...
			throw new IllegalArgumentException("Don't know how to check this object for collision with a MLine: " + s);
	}
