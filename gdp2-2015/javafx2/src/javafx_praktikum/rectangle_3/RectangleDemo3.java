...
import javafx_praktikum.rectangle_3.ctrl.AreaViewController3;
import javafx_praktikum.rectangle_3.model.AreaModel3;
import javafx_praktikum.rectangle_3.view.AreaView3;
import javafx_praktikum.rectangle_3.view.AreaView3.AreaCalcViewConfig;
import javafx_praktikum.rectangle_3.view.AreaView3.DimensionViewConfig;
...
public class RectangleDemo3 extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		AreaModel3 model = new AreaModel3(width, height);
		AreaView3 view = new AreaView3(cfg);

		@SuppressWarnings("unused")
		AreaViewController3 crtl = new AreaViewController3(model, view);
