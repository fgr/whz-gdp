...
/**
 * Die Klasse {@link AreaModel3} demonstriert die Verwendung des Delegation-Patterns (siehe {@link AreaModel3}.
 * 
 * @author Frank Grimm
 */
@ThreadSafe
public class AreaModel3 implements PropertyChangeObservable {
	...
	public AreaModel3(double width, double height) {
		this.width = width;
		this.height = height;
	}
