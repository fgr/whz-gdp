...
import javafx_praktikum.rectangle_2.view.AreaView2.AreaCalcViewObserver.EventType;
 ...
 */
@NotThreadSafe
public final class AreaView2 extends GridPane {
	/**
	...
	public AreaView2(AreaCalcViewConfig cfg) {
		createControls(cfg);
	}
